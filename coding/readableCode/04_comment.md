...
## コメントすべきではないことを知る
上記のコード例では、わざわざコメントすべきではない例を指摘することで、<br>
「コードを読めばわかるコメントを残す必要はない」ことを含んでいます
...
すべき／すべきでないコメントの基準として大事な点は<br>
コメントを残す人間が**読み手の立場になっているか**です
...
（同じチームの人かもしれないし、未来の自分かもしれません）<br>
...
コメントが長くなることは、他人のために残すためどうしても長くなるなど、仕方のない面もあります<br>
しかし冗長なコメントを残すより、混乱を誘う情報は残さず簡潔で分かりやすいコメントの方が「美しい」です
...
「[JSDoc](https://www38.atwiki.jp/aias-jsstyleguide2/pages/14.html)」というフォーマットが存在します<br>
...
コメントとは結局「他人が処理を理解するための補助」として存在します<br>
補助の度合いが人によって異なることを防ぐためにコメントにも規約を決め、<br>
規約に則ったコメントを残すことが重要です
...
しかし中には「コメントを残すのは恥ずかしい…」「これまで書いてこなかったから書き方が分からない」<br>
といった人がいるかと思います
...
もし、コードを書いていて<br>
（ここの処理で文字列を渡されるとやばいな）と思うコードがあるとしましょう<br>
ここで一回で良いコメントを残そうとしてはいけません
...
## まとめ
コメントに限った話ではないですが、技術の習得は手を動かすしかありません<br>
他人のためのコードが残せるように沢山コメントを書きましょう
